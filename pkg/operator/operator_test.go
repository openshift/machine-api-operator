				...
				FeatureGates: []openshiftv1.FeatureGateDetails{
					{
						...
						Disabled: []openshiftv1.FeatureGateAttributes{{Name: features.FeatureGateMachineAPIOperatorDisableMachineHealthCheckController}},
					},
				},
			},
		}
			...
			featureGate: &openshiftv1.FeatureGate{
				...
				Status: openshiftv1.FeatureGateStatus{
					FeatureGates: []openshiftv1.FeatureGateDetails{
						{
							Version:  "",
							Enabled:  []openshiftv1.FeatureGateAttributes{{Name: features.FeatureGateMachineAPIOperatorDisableMachineHealthCheckController}},
