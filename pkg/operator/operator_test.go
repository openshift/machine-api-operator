...
func newFakeOperator(kubeObjects, osObjects, machineObjects []runtime.Object, imagesFile string, stopCh <-chan struct{}) *Operator {
	...
	optr := &Operator{
		...
		mutatingMachineWebhookCache:             resourceapply.NewResourceCache(),
		mutatingMetal3RemediationWebhookCache:   resourceapply.NewResourceCache(),
		mutatingWebhookListerSynced:             mutatingWebhookInformer.Informer().HasSynced,
		validatingMachineWebhookCache:           resourceapply.NewResourceCache(),
		validatingMetal3RemediationWebhookCache: resourceapply.NewResourceCache(),
