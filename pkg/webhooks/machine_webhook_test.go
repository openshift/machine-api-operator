...
func TestMachineCreation(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedError: "invalid marketType: marketType set to Spot and capacityReservationID cannot not used together",
		},
		{
			...
			expectedError: "spotMarketOptions set and capacityReservationID cannot not used together",
		},
		{
