...
func TestMachineCreation(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedError: "admission webhook \"validation.machine.machine.openshift.io\" denied the request: spec.placement.host: Forbidden: host is optional when tenancy is 'host', and forbidden otherwise",
		},
		{
