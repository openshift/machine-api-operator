...
func AddToManagerWithFeatureGates(m manager.Manager, opts manager.Options, featureGateAccessor featuregates.FeatureGateAccess, fnList ...func(manager.Manager, manager.Options, featuregates.FeatureGateAccess) error) error {
