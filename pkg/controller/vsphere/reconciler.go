...
func (r *Reconciler) create() error {
	...
	if r.providerSpec.Workspace.VMGroup != "" && !r.hostVMGroupZonalFeatureGateEnabled {
...
func modifyVMGroup(s *machineScope, delete bool) error {
	...
	if err != nil {
		return fmt.Errorf("error getting resource pool for %s: %w", s.providerSpec.Workspace.ResourcePool, err)
	}
