...
COPY --from=builder /go/src/github.com/openshift/machine-api-operator/owned-manifests .
COPY --from=builder /go/src/github.com/openshift/machine-api-operator/config/manifests .
