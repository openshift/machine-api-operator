...
var (
	...
	DefaultTLSProfileType = configv1.TLSProfileIntermediateType //nolint:gochecknoglobals
	// DefaultTLSCiphers are the default TLS ciphers for API servers.
	DefaultTLSCiphers = configv1.TLSProfiles[DefaultTLSProfileType].Ciphers //nolint:gochecknoglobals
	// DefaultMinTLSVersion is the default minimum TLS version for API servers.
	DefaultMinTLSVersion = configv1.TLSProfiles[DefaultTLSProfileType].MinTLSVersion //nolint:gochecknoglobals
)
