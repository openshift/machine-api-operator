...
var map_DynamicHostAllocationSpec = map[string]string{
	...
	"tags": "tags specifies a set of key-value pairs to apply to the allocated dedicated host. When omitted, no additional user-defined tags will be applied to the allocated host.",
}
