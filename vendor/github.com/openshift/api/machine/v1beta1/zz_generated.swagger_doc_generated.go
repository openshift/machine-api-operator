...
var map_AWSMachineProviderConfig = map[string]string{
	...
	"hostID":                  "HostID specifies the Dedicated Host on which the instance must be started. This field is mutually exclusive with DynamicHostAllocation.",
	"hostAffinity":            "HostAffinity specifies the dedicated host affinity setting for the instance. When HostAffinity is set to host, an instance started onto a specific host always restarts on the same host if stopped. When HostAffinity is set to default, and you stop and restart the instance, it can be restarted on any available host. When HostAffinity is defined, HostID is required.",
}
