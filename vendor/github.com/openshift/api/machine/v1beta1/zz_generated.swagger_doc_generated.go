...
var map_MachineSetStatus = map[string]string{
	...
	"labelSelector":          "labelSelector is the serialized label selector in string form that matches the MachineSet's machines. It is exposed via the scale subresource as status.selector.",
