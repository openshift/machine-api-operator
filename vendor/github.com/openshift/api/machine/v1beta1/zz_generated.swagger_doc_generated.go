...
var map_VSphereDisk = map[string]string{
	...
	"name":    "name is a name to be used to identify the disk definition. If name is not specified, the disk will still be created.  The name should be unique so that it can be used to clearly identify purpose of the disk, but is not required to be unique.",
