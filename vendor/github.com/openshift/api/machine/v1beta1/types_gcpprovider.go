...
type GCPMachineProviderSpec struct {
	...
	// Allowed values are Disabled, Enabled, AMDEncryptedVirtualization, AMDEncryptedVirtualizationNestedPaging, and IntelTrustedDomainExtensions
	...
	// When set to AMDEncryptedVirtualization, it will configure AMD Secure Encrypted Virtualization (AMD SEV) as the confidential computing technology.
	// When set to AMDEncryptedVirtualizationNestedPaging, it will configure AMD Secure Encrypted Virtualization Secure Nested Paging (AMD SEV-SNP) as the confidential computing technology.
	// When set to IntelTrustedDomainExtensions, it will configure Intel TDX as the confidential computing technology.
